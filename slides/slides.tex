...
\date{CS2020/CS2090/CS4340 --- Software Engineering\\October 16th, 2019}
...
\begin{frame}{Backing up: fill in the gaps!}

  \begin{center}
    \includegraphics[width=\textwidth]{backup-statemachine-ex_backup}

    Write down the entry actions for the new states.
  \end{center}

\end{frame}

\begin{frame}{Solution for backing up}

  \begin{center}
    \includegraphics[width=\textwidth]{backup-statemachine-sol_backup}

    \phantom{Write down the entry actions for the new states.}
  \end{center}

\end{frame}

\begin{frame}{Turning around a bit: fill in the gaps!}

  \begin{center}
    \includegraphics[width=\textwidth]{backup-statemachine-ex_rotating}
...
\begin{frame}{Solution for backing up}
  ...
  \begin{center}
    \includegraphics[width=\textwidth]{backup-statemachine-full}
...
\begin{frame}{How would you improve the rover?}
  ...
  \begin{block}{Ideas?}
    Let's brainstorm for a bit! Take into account:
    \begin{itemize}
    \item System complexity
    \item Total cost of the robot
    \item Energy use
    \end{itemize}
  \end{block}
